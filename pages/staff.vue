  ...
  <v-container>
    ...
    <v-row class="texto2">
      ...
      <v-col md="4" class="columna2">
        <v-text-field class="renglon" label="Id" outlined />
        <v-text-field class="renglon1" label="Last Name" outlined />
        <v-text-field class="renglon2" label="Gender" outlined />
        <v-text-field label="Mobile Number" outlined />
        <v-text-field type="date" label="Date Birthday" outlined />
