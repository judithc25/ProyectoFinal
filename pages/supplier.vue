  ...
  <v-container>
    ...
    <v-row class="texto2">
      <v-col md="6">
        ...
        <v-text-field label="Supplier Name" outlined />
        <v-text-field label="Contact Number" outlined />
        <v-text-field label="QTY" outlined />
      </v-col>
      <v-col md="4" class="columna2">
        <v-text-field class="renglon" label="Supplier Id" outlined />
        <v-text-field class="renglon1" label="Location" outlined />
        <v-text-field class="renglon2" label="Medicine Name" outlined />
        <v-text-field
          label="Unit Price"
          outlined
